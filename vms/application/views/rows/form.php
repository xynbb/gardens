<div class="panel panel-default">
  <div class="panel-body">
    <form class="form-horizontal" role="form" method="post" action="">
      ...
      <input type="hidden" name="area_id" value="<?php echo isset($areaId) ? $areaId : '0'; ?>" />
      <div class="form-group">
        <label class="col-md-2 control-label">名称<span style="color: red;">*</span></label>
        <div class="col-md-6">
          <input type="text" class="form-control" name="name" value="<?php echo isset($row) && is_object($row) ? $row->getName() : ''; ?>" placeholder="排名称"/>
        </div>
      </div>
        <div class="form-group">
...
<script>
var url = "<?php echo URL::site('rows/save'); ?>";
$(function() {
