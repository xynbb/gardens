    ...
    DateRangePicker.prototype = {
        ...
        clickDate: function (e) {
            ...
            if (cal.hasClass('left')) {
                ...
                //在每个小时的第(60-（this.timePickerIncrement))分到第59分时选今天的出现NAN的bug
                if(this.minDate && startDate.year() == this.minDate.year() && startDate.month() ==  this.minDate.month() && startDate.date() ==  this.minDate.date()){
                    var minute = parseInt(cal.find('.minuteselect').val(), 10);
                    if (this.minDate.minute() + this.timePickerIncrement > 60) {
                        ...
                        this.minDate.hour(hour);
                        this.minDate.minute(minute);
                    }
                }
                //@author xueying6
                endDate = this.endDate;
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate, side) {
            ...
            if (this.timePicker) {
                ...
                for (i = start; i <= end; i++) {
                    ...
                    //在每个小时的第(60-（this.timePickerIncrement))分到第59分时出现NAN
                    if(minDate && selected_hour == minDate.hour() && minDate.minute() + this.timePickerIncrement >= 60) {
                        if (i == selected_hour + 1) {
                            html += '<option value="' + i + '" selected="selected">' + i + '</option>';
                        } else if (i < min_hour + 1 || i > max_hour) {
