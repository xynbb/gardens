  ...
  SelectAdapter.prototype.item = function ($option) {
    ...
    if ($option.is('option')) {
      data = {
        id: $option.val(),
        text: $option.html(),
        keyword: $option.attr("data-keyword"),
        showname: $option.attr("data-showname"),
...
define('select2/i18n/zh',[],function () {
  // Chinese
  return {
    errorLoading: function () {
      return '加载失败';
    ...
    inputTooShort: function (args) {
      ...
      var message = '请输入 ' + remainingChars + ' 个字符';
    ...
    maximumSelected: function (args) {
      var message = '你只能选择 ' + args.maximum + ' 个项目';
...
define('select2/i18n/zh-CN',[],function () {
  // Chinese
  return {
    errorLoading: function () {
      return '加载失败';
  ...
  Defaults.prototype.reset = function () {
    ...
    function matcher (params, data) {
      ...
      if(data.keyword != null) {
        var original = stripDiacritics(data.keyword).toUpperCase();
      } else {
    ...
    this.defaults = {
      ...
      templateSelection: function (selection) {
        if(selection.showname != null) {
          return selection.showname;
        } else {
