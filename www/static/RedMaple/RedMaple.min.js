jQuery(function ($){
	$.RedMaple	= {
					...
					load:{
							js:function(url,func)
							{
								...
								for(var i in urls)
								{
									...
									{
										eval($.RedMaple.interior.loadFiles[_key]);
										func?func():'';
										continue;
									}

									$.RedMaple.interior.loadFiles[_key] = $.RedMaple.interior.jQueryAjax({type:"GET",url:urls[i],async:false}).responseText;
										...
										search:function(pageNo)
										{
											...
											if(pageNo)
											{
												if($("#"+page).size()>0)
													...
													_form.form.append('<input name="'+page+'" type="hidden" value="'+pageNo+'"  autocomplete="off" id="'+page+'">');	
											}
					...
					layer:
					{
						iframe:function(src,title,width,height)
					    {
							...
							var options = {
											...
											border: [5, 0.3, '#000'],
											offset: ['20px',''],
											area: [width?width:'60%', height?height:($(window).height() - 50) +'px']
										};
