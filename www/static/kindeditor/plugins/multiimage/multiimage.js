	...
	init : function(options) {
		...
		var settings = {
			...
			upload_success_handler : function(file, serverData) {
                ...
                //改造数据
                var temp_data = {"error":1,"message":"","url":""}
                if(data.status){
                    temp_data.error = 0
                    temp_data.url = I_URL+data.message
                }
                data = temp_data
...
KindEditor.plugin('multiimage', function(K) {
	//alert( IMG_URL+'?editorid=1&'+$("#sign_str").val());return;
	var self = this, name = 'multiimage',
		formatUploadUrl = K.undef(self.formatUploadUrl, true),
        uploadJson = K.undef(self.uploadJson, IMG_URL+'?editorid=1&'+$("#sign_str").val()),
